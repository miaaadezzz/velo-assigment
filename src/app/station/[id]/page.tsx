      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-[#B9B9B9] p-8 flex flex-col items-center">
        <div className="flex flex-col items-center mb-6">
          ...
          <div className="flex flex-row items-center gap-2 mb-1">
            <h1 className="text-2xl font-extrabold text-[#2D3A46] text-center">
              {station.name}
            </h1>
            {distance !== null && (
        ...
        <Link
          href="/"
          className="mt-4 bg-[#B0C0CF] text-white px-6 py-2 rounded-full text-sm font-semibold shadow hover:bg-[#8A9BAF] transition"
        >
          ← Terug naar overzicht
        </Link>
        <Link
          href={`/station/${station.id}/navigation`}
          className="mt-2 bg-[#B0C0CF] text-white px-6 py-2 rounded-full text-sm font-semibold shadow hover:bg-[#8A9BAF] transition flex items-center gap-2"
        >
